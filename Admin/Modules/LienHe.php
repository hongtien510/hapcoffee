<?php
	$sql="select * from baiviet where loaibaiviet='LienHe'";
	//echo $sql;
	$rs=mysql_query($sql);
	$r=mysql_fetch_assoc($rs);
		...
		if(isset($_POST['submit']))
		{
			...
			if($TieuDeBGT==""){
				...
				if($r['tenbaiviet']==""){
					$sql2="insert into baiviet values(NULL,'$TieuDeBGT','$NoiDungBGT','','$AnHien','LienHe')";
					mysql_query($sql2);
				...
				if($r['tenbaiviet']!=""){
					...
					//echo $sql2;			 
					mysql_query($sql2);
					echo '<script>alert("Cap nhat thanh cong");window.location="?action=LienHe";</script>';
				}
			}
		}
?>
<div class="BaiViet">
<h2 class="style_text_2">Liên hệ</h2>
		...
		<table width="90%" border="1" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
			<th  align="right" valign="top" scope="row">Địa chỉ liên hệ : </th>
			<td valign="top">
		  ...
		  <tr>
	        ...
	        <i>(Chọn nếu muốn bài viết không hiển thị)</i></td>
	      </tr>
		  <tr>
