...
<div class="pp_right">
	<form action="" method="post">
		<h2 class="style_text_2">Hệ thống phân phối ngoài nước</h2>
  ...
  <tr>
   ...
   <?php
	$sql="select * from phanphoi where loaiphanphoi='NgoaiNuoc' order by thutu";
	$rs=mysql_query($sql);
	$i=1;
  ...
  <tr>
    ...
    <td align="center" valign="middle">
	<a href="?action=PhanPhoi_NgoaiNuoc_Sua&maphanphoi=<?php echo $r['maphanphoi']?>"><img src="images/b_edit.png" width="16" height="16" border="0" /></a>
    <a onclick="return confirm('Bạn có chắc chắn muốn xóa không !!! ');" href="?action=PhanPhoi_NgoaiNuoc_Xoa&maphanphoi=<?php echo $r['maphanphoi']?>"><img src="images/b_drop.png" width="16" height="16" border="0" /></a>
	</td>
  </tr>
  <?php }?>
  <tr>
    <td colspan="7" align="right" valign="middle">
	<input onclick="window.location.href='?action=PhanPhoi_NgoaiNuoc_Them'" type="button" name="them" id="them" value="Thêm nhà phân phối" /></td>
