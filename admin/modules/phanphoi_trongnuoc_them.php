...
<?php
	...
	if(isset($_POST['submit']))
	{
		...
		$sql="insert into phanphoi values('NULL','$TenNhaPhanPhoi','$DiaChi','$DienThoai', '$Email', '$UrlHinh', 'TrongNuoc', '$ThuTu', '$AnHien')";
		mysql_query($sql);
		//echo $sql;
		echo'<script>alert("Thêm nhà phân phối thành công");window.location="?action=PhanPhoi_TrongNuoc";</script>';
	}
?>
