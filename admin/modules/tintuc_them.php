		...
		if(isset($_POST['submit']))
		{
			...
			if($TieuDeBGT==""){
				echo '<script>alert("Ban Chưa Nhâp Tiêu Đề Bài Viết")</script>';
					...
					$sql2="insert into baiviet values(NULL,'$TieuDeBGT','$NoiDungBGT','','$AnHien','tintuc')";
					mysql_query($sql2);
					echo '<script>alert("Thêm bài viết thành công");window.location="?action=TinTuc";</script>';
			}
		}
?>
<div class="BaiViet">
