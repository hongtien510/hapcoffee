<div id="category">
	...
	<div id="content_cat">
		...
		$total = mysql_result(mysql_query("select COUNT(mabv) from baiviet where anhien=0 and loaibaiviet='tintuc'"),0);
		$numofpages = $total / $pp;
		if (!$p_now) {$page = 1;}
		else {$page = $p_now;}
...
?>
	...
	<ul class="ul_page">
	<?php
	page_div("tintuc.html?page=%d_pg", "10", ceil($numofpages), $page); 	
	?>
	</ul>
</div>